...
#define IntArrayInput(intarray,n) scanf("%d",&n); for(int i=0;i<(n);++i) scanf("%d", &intarray[i]);
#define IntArrayOutput(intarray,n) for(int i=0;i<(n);++i) {printf("%d ", intarray[i]);} printf("\n");
